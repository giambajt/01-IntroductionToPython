...
annabeth = rg.SimpleTurtle('turtle')
annabeth.pen = rg.Pen('blue', 1)
annabeth.left(90)
annabeth.forward(200)
annabeth.pen_up()
annabeth.go_to(rg.Point(100,-40))
annabeth.pen_down()
annabeth.pen = rg.Pen('green', 10)
annabeth.left(180)
annabeth.forward(150)
